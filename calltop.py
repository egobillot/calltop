...
def create_and_load_bpf(syscall=b'all', lat=False):
    ...
    For latency #define LATENCY is added.
        Args:
            syscall (:obj:`list` of :obj:`str`): syscall name.
...
def main():
    ...
    try:
        ...
        b = create_and_load_bpf(syscall=syscall_list, lat=latency)
